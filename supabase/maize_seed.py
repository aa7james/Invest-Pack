"""
Seed SA Maize Crop Progress history (from Crop Data New, normalised to million
tons) and convert the Maize Crop Progress panel into a seasonal chart.
...
def main():
    ...
    rows = json.load(open(os.path.join(HERE, 'maize_data.json')))
    ...
    print('seeded', len(payload), 'points')
    ...
    print('converted Maize Crop Progress -> seasonal chart')
